...
public class ProjectRepository {
    ...
    public List<Project> getProjects() {
        ...
        mProjects.add(new Project(
                "D-Cent / Nesta", "D-Cent Pilot Release 2", "a", 4, "John Michaelides",
                new GregorianCalendar(2015, 5, 1).getTime(), "London Office", 90, "", "Tactical", ""));
        mProjects.add(new Project(
                "Global Blue SA", "GB:Programme/advisory 2015 Q2", "b", 3, "Barbara Philips",
                new GregorianCalendar(2015, 7, 1).getTime(), "London", 80, "", "Target", ""));
        mProjects.add(new Project(
                "Morrisons", "Tablet Apps", "c", 11, "Joe Lubczynskj",
